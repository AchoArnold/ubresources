...
<html>
  ...
  <body>
    <header class="navbar navbar-default navbar-fixed-top" role="navigation">
          ...
          <div class="main-content">
            <div class="col-md-9">
              <div class="alert alert-danger">
                ...
                echo  $error. "</p>";
                echo "<br />";
                echo "<a class=\"btn btn-danger\" href=\"../contribute/error.html\">Go Back and fix these errors</a>";
              echo "</div>";
            echo "</div>";
          echo "</div>";
        echo "</section>";
      ...
      {
      died('Sorry, we didn\'t get your message');
      }
    
      
        $email_from = $_POST['Your_Email'];
